...
root.title("Face Mask And Social Distancing System")
...
#
label_l1 = tk.Label(root, text="Face Mask And Social Distancing System",font=("Times New Roman", 35, 'bold'),
...
button1 = tk.Button(root, text="Face Mask Detection", command=log, height=1,font=('times', 20, ' bold '), bg="#152238", fg="white")
